...
export class ApiService {
  ...
  static async getSuggestedCategory(description: string): Promise<{
    category: string;
    confidence: number;
    reasoning: string;
    aiGenerated: boolean;
  }> {
    const { data } = await apiClient.post("/ai/suggest-category", {
      description,
    });
    ...
    return {
      ...
      aiGenerated: data.suggestion.aiGenerated,
    };
  }
  ...
  static async getRecurringExpenseById(
    id: string,
  ...
  static async deleteRecurringExpense(
    id: string,
  ...
  static async getUpcomingRecurringExpenses(): Promise<{
